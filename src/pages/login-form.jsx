        ...
        <div className="inter-font container">
            ...
            >
                <Form className="login-form">
                    ...
                    <a className="link" href="#">Esqueceu a senha?</a>
                    <button className="red-Button" type="submit">Login</button>
                </Form>
            </Formik>
            <br/>
            <p className="align-text-center">Não possui uma conta? <a href="#" className="red-Color inter-semibold-font" onClick={() => props.changePage(2)}>Inscreva-se</a></p>
        </div>
    )
}
